                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="fw-semibold"><?php echo $search ? str_ireplace($search, '<mark>' . $search . '</mark>', $category->name) : $category->name; ?></td>
                                <td>
                                    <span title="<?php echo e($category->description); ?>">
                                        <?php echo $search ? str_ireplace($search, '<mark>' . $search . '</mark>', Str::limit($category->description, 40)) : Str::limit($category->description, 40); ?>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Alqadsy API\Alqadsy Web\resources\views\admin\categories\index.blade.php ENDPATH**/ ?>