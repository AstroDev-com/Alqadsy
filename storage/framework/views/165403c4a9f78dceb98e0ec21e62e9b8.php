...
<head>
    ...
    <meta name="keywords" content="<?php echo e($metaKeywords); ?>, ورشة القدسي, ورشة عبدالحكيم القدسي, القدسي للحديد, القدسي">
    ...
    <meta name="twitter:url" content="<?php echo e($currentUrl); ?>">
    ...
    <meta name="twitter:image" content="<?php echo e($siteLogo); ?>">
    ...
    ?>
    <?php echo json_encode($localBusinessSchema, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT); ?>
...
<?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Hostinger\Alqadsy Hostinger\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>