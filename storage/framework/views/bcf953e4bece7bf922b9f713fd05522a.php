<?php if($paginator->hasPages()): ?>
    <nav>
        <?php if(!Route::is('about')): ?>
            <div class="d-flex justify-content-center d-sm-none mb-2">
                <p class="small text-muted mb-0">
                    <?php echo e(__('عرض الصفحة')); ?> <?php echo e($paginator->currentPage()); ?> <?php echo e(__('من')); ?> <?php echo e($paginator->lastPage()); ?> | <?php echo e(__('إجمالي الصور')); ?>: <?php echo e($paginator->total()); ?>
...
<?php endif; ?>
<?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Hostinger\Alqadsy Hostinger\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>