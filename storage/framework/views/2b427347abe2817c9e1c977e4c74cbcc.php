    ...
    <div class="header-left">
        ...
        <div class="dropdown notification-dropdown">
            ...
            <ul class="dropdown-menu <?php echo e($isRTL ? 'dropdown-menu-start' : 'dropdown-menu-end'); ?> shadow border-0 mt-2"
                ...
                <?php if($unreadNotificationsForLayout->isEmpty()): ?>
                    <li>
                ...
                <?php else: ?>
                    <?php $__currentLoopData = $unreadNotificationsForLayout->take(7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
...
<?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Alqadsy API\Alqadsy Web\resources\views\admin\includes\header.blade.php ENDPATH**/ ?>