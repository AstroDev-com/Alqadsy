        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2 order-2 order-xl-1 text-left text-xl-right" data-aos="fade-down">
            <a href="<?php echo e(url('/')); ?>">
              <img src="<?php echo e(asset('frontend/images/Alqadsy.png')); ?>" alt="ورشة القدسي" style="max-width: 90px; height: auto; border-radius: 50%;" />
            </a>
          </div>
...
<?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Hostinger\Alqadsy Hostinger\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>