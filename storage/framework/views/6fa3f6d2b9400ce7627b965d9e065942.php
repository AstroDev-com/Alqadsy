                            ...
                            <li class="list-group-item conversation-item <?php echo e($isUnread ? 'unread' : 'read'); ?>">
                                <a href="<?php echo e(route('conversations.show', $conversation->id)); ?>"
                                    ...
                                    <div class="participant-avatars <?php echo e($isRTL ?? false ? 'ms-3' : 'me-3'); ?>">
                                        <?php if($displayParticipants->isEmpty()): ?>
                                            <span class="avatar-placeholder"><i class="fas fa-user"></i></span>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $displayParticipants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Alqadsy API\Alqadsy Web\resources\views\admin\conversations\index.blade.php ENDPATH**/ ?>