        ...
        <div class="row align-items-center my-5">
            ...
            <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right">
                <div class="position-relative">
                    <img src="{{ asset('frontend/images/img_2.jpg') }}" alt="ورشة القدسي - أعمال الحديد" class="img-fluid rounded-lg shadow-lg" style="object-fit: cover; height: 500px; width: 100%; border-radius: 15px; border: 1px solid rgba(255,255,255,0.1);">
