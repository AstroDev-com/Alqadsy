...
unset($__errorArgs, $__bag); ?>">
                                            <option value="1"
                                                <?php echo e(old('status', $permission->status) == 1 ? 'selected' : ''); ?>>مفعل
                                            </option>
                                            <option value="0"
                                                <?php echo e(old('status', $permission->status) == 0 ? 'selected' : ''); ?>>غير مفعل
                                            </option>
                                        </select>
                                        <label for="status">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Alqadsy API\Alqadsy Web\resources\views\admin\role-permission\permission\edit.blade.php ENDPATH**/ ?>