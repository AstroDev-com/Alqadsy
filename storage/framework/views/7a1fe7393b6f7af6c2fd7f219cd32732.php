...
<head>
    ...
    <style>
        ...
        [data-theme="dark"] .form-select:focus {
            background-color: var(--card-bg);
            color: var(--text-color);
            border-color: #20c997; /* Optional: theme color for focus */
        }
...
<?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Hostinger\Alqadsy Hostinger\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>