<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            <h1 class="fw-bold mb-2" color="black" style="font-size:2rem;"><?php echo e(__('dashboard.products')); ?></h1>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\All My Project\GitHub_Project\AstroDev GitHub\Alqadsy\Alqadsy\resources\views/admin/products/index.blade.php ENDPATH**/ ?>